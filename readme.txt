...
<h3>FEATURES FOR CONTACT FORM 7 PDF WAIVER SIGNATURE:</h3>

* Easy to use
* Map form inputs to uploaded pdf document
* Save filled out pdf on server
* Keeps database record of date and ip address of signature/form filling out
* Can change the signature pad background color and pen color.
* Can embed pdf in the form
* Can add a custom class and id in signature pad
* open any form then you can see **Signature** button on top.
* Draw your signature then you can clear the signature pad
	
== CONTRIBUTE AND TRANSLATE ==
	
Sign PDF Waiver for Contact Form 7 is ready to be translated into multiple languages. Help localize Contact Form 7 PDF Waiver Signature even further by adding your locale Language. [Click Here](replace with final url)

== FAQ ==
= Sign PDF Waiver for Contact Form 7 Shortcode =
[cf7w_signature  cf7w_signature -100 color:#fffff backcolor:#00000 width:400 height:200]	
...
2. Signature field options
3. PDF Upload and field placement
